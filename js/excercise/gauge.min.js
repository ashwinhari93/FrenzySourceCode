...
(function() {
    var AnimatedText, AnimatedTextFactory, Bar, BaseDonut, BaseGauge, Donut, Gauge, GaugePointer, TextRenderer, ValueUpdater, addCommas, formatNumber, mergeObjects, secondsToString, updateObjectValues, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
        ...
        ValueUpdater.prototype.update = function(force) {
            ...
            if (force || this.displayedValue !== this.value) {
                ...
                if (Math.abs(diff / this.animationSpeed) <= 0.001) {
                    ...
                    this.displayedValue = this.value;//this.displayedValue + diff / this.animationSpeed;
                }
                this.render();
                return true;
            }
...
//            }
    ...
    Gauge = (function(_super) {
        ...
        Gauge.prototype.options = {colorStart: "#6fadcf", colorStop: void 0, strokeColor: "#e0e0e0", pointer: {length: 0.8, strokeWidth: 0.035}, angle: 0.15, lineWidth: 0.44, fontSize: 40};
