...
function openPopDiv(e,t){if(t==undefined){t="bounceInDown"}if(document.getElementById("fade")){$("#fade").remove()}popIndex++;var n="fade-"+e;$('<div id="'+n+'"></div>').appendTo($("body"));/*$("#"+n).click(function(){closePopDiv(e)});*/compDiv=e;centerPopup(e);loadPopup(e,t)}function loadPopup(e,t){$("#fade-"+e).fadeIn(200);$("#"+e).addClass(t).fadeIn(200);setTimeout(function(){$("#"+e).removeClass(t)},1100)}function closePopDiv(e,t){if(t==undefined){t="bounceOutUp"}compDiv=e;disablePopup(e,t)}function disablePopup(e,t){$("#"+e).addClass(t);$("#fade-"+e).fadeOut("fast");popIndex=popIndex-1;setTimeout(function(){$("#"+e).fadeOut("fast",function(){$("#"+e).removeClass(t);$("#fade-"+e).remove()})},200)}function centerPopup(e){var t=$(document).width();var n=$(document).height();var r=$("#"+e).height();var i=$("#"+e).width();arrPageScroll=___getPageScroll();arrPageSizes=___getPageSize();$("#"+e).css({position:"absolute",top:arrPageSizes[3]/2-$("#"+compDiv).height()/2+getScrollTop()+"px",left:t/2-i/2,"z-Index":popIndex+1});ems=parseInt($("#"+e).css("top"));if(ems<0){$("#"+e).css({position:"absolute",top:10})}$("#fade-"+e).css({height:"100%",opacity:.7,width:"100%",backgroundColor:"#fff",position:"fixed","z-index":popIndex,left:0,top:0})}function ___getPageSize(){var e,t;if(window.innerHeight&&window.scrollMaxY){e=window.innerWidth+window.scrollMaxX;t=window.innerHeight+window.scrollMaxY}else if(document.body.scrollHeight>document.body.offsetHeight){e=document.body.scrollWidth;t=document.body.scrollHeight}else{e=document.body.offsetWidth;t=document.body.offsetHeight}var n,r;if(self.innerHeight){if(document.documentElement.clientWidth){n=document.documentElement.clientWidth}else{n=self.innerWidth}r=self.innerHeight}else if(document.documentElement&&document.documentElement.clientHeight){n=document.documentElement.clientWidth;r=document.documentElement.clientHeight}else if(document.body){n=document.body.clientWidth;r=document.body.clientHeight}if(t<r){pageHeight=r}else{pageHeight=t}if(e<n){pageWidth=e}else{pageWidth=n}arrayPageSize=new Array(pageWidth,pageHeight,n,r);return arrayPageSize}function ___getPageScroll(){var e,t;if(self.pageYOffset){t=self.pageYOffset;e=self.pageXOffset}else if(document.documentElement&&document.documentElement.scrollTop){t=document.documentElement.scrollTop;e=document.documentElement.scrollLeft}else if(document.body){t=document.body.scrollTop;e=document.body.scrollLeft}arrayPageScroll=new Array(e,t);return arrayPageScroll}function getScrollTop(){var e=document.body.scrollTop;if(e==0){if(window.pageYOffset)e=window.pageYOffset;else e=document.body.parentElement?document.body.parentElement.scrollTop:0}return e}var compDiv;var arrPageScroll;var arrPageSizes=new Array;var anim;var popIndex=7e3;var compDiv;var arrPageScroll;var arrPageSizes=new Array;var anim;$(window).resize(function(){$("#fade").width($(window).width()).height($(document).height());/*closePopDiv(compDiv)*/});$(document).ready(function(){$("#fade").click(function(){closePopDiv(compDiv)});$(document).keydown(function(e){if(e.keyCode==27){closePopDiv(compDiv)}});
$(window).scroll(function(){/*$("#"+compDiv).stop().animate({top:arrPageSizes[3]/2-$("#"+compDiv).height()/2+getScrollTop()+"px",opacity:1},500)*/})});
