...
$.extend(Network_linkedin.prototype,{
    ...
    checkFriendsInDatabase:function(friend_ids){
       ...
       if(friend_ids._total == 0){
        ...
        $.ajax({
            ...
            data: 'social_type=7&LoginSessionKey='+LoginSessionKey+'&friend_ids='+JSON.stringify(linkedin_ids),
            type: "POST",
            success: function(data){
                //console.log(data);
    ...
    saveLinkedInInvitation:function(id){
        ...
        $.ajax({
            ...
            data:'invite_type=7&social_id='+id+'&LoginSessionKey='+LoginSessionKey,
            type:"POST",
            success:function(data){
