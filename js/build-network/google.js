...
function shareOnGoogle(){
    ...
    if(inviteTime==0){
        ...
        $.post(base_url+'api/build_network/googleInvitation',{'LoginSessionKey':$('#LoginSessionKey').val(),Token:Token},function(r){
        });
    ...
    gapi.interactivepost.render('google_invite_others', options);
